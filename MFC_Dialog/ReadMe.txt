========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : MFC_Dialog
========================================================================


AppWizard has created this MFC_Dialog application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MFC_Dialog application.
...
MFC_Dialog.h
    ...
    CMFC_DialogApp application class.

MFC_Dialog.cpp
    This is the main application source file that contains the application
    class CMFC_DialogApp.
...
res\MFC_Dialog.ico
    ...
    icon is included by the main resource file MFC_Dialog.rc.
...
MFC_DialogDlg.h, MFC_DialogDlg.cpp - the dialog
    These files contain your CMFC_DialogDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in MFC_Dialog.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMFC_DialogDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named MFC_Dialog.pch and a precompiled types file named StdAfx.obj.

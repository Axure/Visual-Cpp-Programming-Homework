========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Engineering
========================================================================


AppWizard has created this Engineering application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Engineering application.
...
Engineering.h
    ...
    CEngineeringApp application class.

Engineering.cpp
    This is the main application source file that contains the application
    class CEngineeringApp.
...
res\Engineering.ico
    ...
    icon is included by the main resource file Engineering.rc.
...
EngineeringDlg.h, EngineeringDlg.cpp - the dialog
    These files contain your CEngineeringDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Engineering.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CEngineeringDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Engineering.pch and a precompiled types file named StdAfx.obj.
